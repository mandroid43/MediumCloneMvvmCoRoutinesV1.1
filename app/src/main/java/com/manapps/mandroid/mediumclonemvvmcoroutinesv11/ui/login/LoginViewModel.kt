...
import com.manapps.mandroid.mediumclonemvvmcoroutinesv11.data.models.entities.LoginData
...
class LoginViewModel(val repository: LoginRepository, val context: Context) : ViewModel() {
  ...
  fun onEmailChanged(email: String) {
    ...
    private fun setLoginError(message: String) {
        ...
        _loginResultLiveData.postValue(Resource.error(null, context.resources.getString(R.string.invalidLoginCredentials)))
    }
